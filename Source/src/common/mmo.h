...
#define MAX_MAP_PER_SERVER 2000	//1500 /// Increased to allow creation of Instance Maps
#define MAX_INVENTORY 100 ///Maximum items in player inventory
/** Max number of characters per account. Note that changing this setting alone is not enough if the client is not hexed to support more characters as well.
* Max value tested was 265 */
#define MAX_CHARS 15	//9 
...
#define MAX_STORAGE 800	//600 ///Max number of storage slots a player can have
#define MAX_GUILD_STORAGE 900	//600 ///Max number of storage slots a guild
